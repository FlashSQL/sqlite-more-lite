...
const char *sqlite3OpcodeName(int i){
 static const char *const azName[] = {
    ...
    /*  21 */ "If"               OpHelp(""),
    /*  22 */ "IfNot"            OpHelp(""),
    /*  23 */ "Or"               OpHelp("r[P3]=(r[P1] || r[P2])"),
    /*  24 */ "And"              OpHelp("r[P3]=(r[P1] && r[P2])"),
    /*  25 */ "SeekLT"           OpHelp("key=r[P3@P4]"),
    /*  26 */ "SeekLE"           OpHelp("key=r[P3@P4]"),
    /*  27 */ "SeekGE"           OpHelp("key=r[P3@P4]"),
    /*  28 */ "SeekGT"           OpHelp("key=r[P3@P4]"),
    /*  29 */ "NoConflict"       OpHelp("key=r[P3@P4]"),
    /*  30 */ "IsNull"           OpHelp("if r[P1]==NULL goto P2"),
    /*  31 */ "NotNull"          OpHelp("if r[P1]!=NULL goto P2"),
    /*  32 */ "Ne"               OpHelp("if r[P1]!=r[P3] goto P2"),
    /*  33 */ "Eq"               OpHelp("if r[P1]==r[P3] goto P2"),
    /*  34 */ "Gt"               OpHelp("if r[P1]>r[P3] goto P2"),
    /*  35 */ "Le"               OpHelp("if r[P1]<=r[P3] goto P2"),
    /*  36 */ "Lt"               OpHelp("if r[P1]<r[P3] goto P2"),
    /*  37 */ "Ge"               OpHelp("if r[P1]>=r[P3] goto P2"),
    /*  38 */ "NotFound"         OpHelp("key=r[P3@P4]"),
    /*  39 */ "BitAnd"           OpHelp("r[P3]=r[P1]&r[P2]"),
    /*  40 */ "BitOr"            OpHelp("r[P3]=r[P1]|r[P2]"),
    /*  41 */ "ShiftLeft"        OpHelp("r[P3]=r[P2]<<r[P1]"),
    /*  42 */ "ShiftRight"       OpHelp("r[P3]=r[P2]>>r[P1]"),
    /*  43 */ "Add"              OpHelp("r[P3]=r[P1]+r[P2]"),
    /*  44 */ "Subtract"         OpHelp("r[P3]=r[P2]-r[P1]"),
    /*  45 */ "Multiply"         OpHelp("r[P3]=r[P1]*r[P2]"),
    /*  46 */ "Divide"           OpHelp("r[P3]=r[P2]/r[P1]"),
    /*  47 */ "Remainder"        OpHelp("r[P3]=r[P2]%r[P1]"),
    /*  48 */ "Concat"           OpHelp("r[P3]=r[P2]+r[P1]"),
    /*  49 */ "Found"            OpHelp("key=r[P3@P4]"),
    /*  50 */ "BitNot"           OpHelp("r[P1]= ~r[P1]"),
    /*  51 */ "NotExists"        OpHelp("intkey=r[P3]"),
    /*  52 */ "Last"             OpHelp(""),
