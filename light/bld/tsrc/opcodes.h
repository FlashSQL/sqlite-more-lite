...
#define OP_Yield          17
#define OP_MustBeInt      18
#define OP_Jump           19
#define OP_Once           20
#define OP_If             21
#define OP_IfNot          22
#define OP_Or             23 /* same as TK_OR, synopsis: r[P3]=(r[P1] || r[P2]) */
#define OP_And            24 /* same as TK_AND, synopsis: r[P3]=(r[P1] && r[P2]) */
#define OP_SeekLT         25 /* synopsis: key=r[P3@P4]                     */
#define OP_SeekLE         26 /* synopsis: key=r[P3@P4]                     */
#define OP_SeekGE         27 /* synopsis: key=r[P3@P4]                     */
#define OP_SeekGT         28 /* synopsis: key=r[P3@P4]                     */
#define OP_NoConflict     29 /* synopsis: key=r[P3@P4]                     */
#define OP_IsNull         30 /* same as TK_ISNULL, synopsis: if r[P1]==NULL goto P2 */
#define OP_NotNull        31 /* same as TK_NOTNULL, synopsis: if r[P1]!=NULL goto P2 */
#define OP_Ne             32 /* same as TK_NE, synopsis: if r[P1]!=r[P3] goto P2 */
#define OP_Eq             33 /* same as TK_EQ, synopsis: if r[P1]==r[P3] goto P2 */
#define OP_Gt             34 /* same as TK_GT, synopsis: if r[P1]>r[P3] goto P2 */
#define OP_Le             35 /* same as TK_LE, synopsis: if r[P1]<=r[P3] goto P2 */
#define OP_Lt             36 /* same as TK_LT, synopsis: if r[P1]<r[P3] goto P2 */
#define OP_Ge             37 /* same as TK_GE, synopsis: if r[P1]>=r[P3] goto P2 */
#define OP_NotFound       38 /* synopsis: key=r[P3@P4]                     */
#define OP_BitAnd         39 /* same as TK_BITAND, synopsis: r[P3]=r[P1]&r[P2] */
#define OP_BitOr          40 /* same as TK_BITOR, synopsis: r[P3]=r[P1]|r[P2] */
#define OP_ShiftLeft      41 /* same as TK_LSHIFT, synopsis: r[P3]=r[P2]<<r[P1] */
#define OP_ShiftRight     42 /* same as TK_RSHIFT, synopsis: r[P3]=r[P2]>>r[P1] */
#define OP_Add            43 /* same as TK_PLUS, synopsis: r[P3]=r[P1]+r[P2] */
#define OP_Subtract       44 /* same as TK_MINUS, synopsis: r[P3]=r[P2]-r[P1] */
#define OP_Multiply       45 /* same as TK_STAR, synopsis: r[P3]=r[P1]*r[P2] */
#define OP_Divide         46 /* same as TK_SLASH, synopsis: r[P3]=r[P2]/r[P1] */
#define OP_Remainder      47 /* same as TK_REM, synopsis: r[P3]=r[P2]%r[P1] */
#define OP_Concat         48 /* same as TK_CONCAT, synopsis: r[P3]=r[P2]+r[P1] */
#define OP_Found          49 /* synopsis: key=r[P3@P4]                     */
#define OP_BitNot         50 /* same as TK_BITNOT, synopsis: r[P1]= ~r[P1] */
#define OP_NotExists      51 /* synopsis: intkey=r[P3]                     */
#define OP_Last           52
...
/*  16 */ 0x12, 0x03, 0x03, 0x01, 0x01, 0x03, 0x03, 0x26,\
/*  24 */ 0x26, 0x09, 0x09, 0x09, 0x09, 0x09, 0x03, 0x03,\
/*  32 */ 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x09, 0x26,\
/*  40 */ 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26,\
/*  48 */ 0x26, 0x09, 0x12, 0x09, 0x01, 0x01, 0x01, 0x01,\
...
/*  96 */ 0x00, 0x10, 0x10, 0x00, 0x10, 0x00, 0x00, 0x00,\
